...
## Type: Dict
# c.aliases = {'wq': 'quit --save', 'q': 'quit', 'w': 'session-save'}
...
## Type: Dict
# c.bindings.key_mappings = {'<Shift-Enter>': '<Return>', '<Ctrl-[>': '<Escape>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-J>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-M>': '<Return>', '<Enter>': '<Return>', '<Shift-Return>': '<Return>'}
...
## Type: Dict
# c.content.javascript.log = {'info': 'debug', 'unknown': 'debug', 'error': 'debug', 'warning': 'debug'}
